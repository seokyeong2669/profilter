...
class _HomePageState extends State<HomePage> {
  ...
  bool button_color = false; //셔터와 stop 아이콘 색상변경을 위한 변수
  ...
  void _onScrollEvent() {
    ...
    } else if (extentAfter < 310) {
      setState(() {
        filter_type = 'f6';
      });
    } else if (extentAfter < 360) {
      setState(() {
        filter_type = 'f5';
      });
    } else if (extentAfter < 410) {
      setState(() {
        filter_type = 'f4';
      });
    } else if (extentAfter < 460) {
      setState(() {
        filter_type = 'f3';
      });
    } else if (extentAfter < 510) {
      setState(() {
        filter_type = 'f2';
      });
                ...
                Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      child: Container(
                        height: 85,
                        margin: EdgeInsets.only(left: 75, bottom: 45),
